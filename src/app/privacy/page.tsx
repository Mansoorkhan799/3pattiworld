...
export const metadata: Metadata = {
  title: 'Privacy Policy - 3 Patti World | Your Privacy Matters',
  description: 'Read our privacy policy to understand how 3 Patti World collects, uses, and protects your personal information. We are committed to your data security.',
  keywords: ['3 Patti World privacy policy', 'privacy', 'data protection', 'user privacy', 'data security'],
  openGraph: {
    title: 'Privacy Policy - 3 Patti World',
    description: 'Learn how 3 Patti World protects your personal information and data.',
    url: 'https://3pattiworldapp.com.pk/privacy',
    siteName: '3 Patti World',
    type: 'website',
  },
  alternates: {
    canonical: 'https://3pattiworldapp.com.pk/privacy',
  },
};
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="bg-[#0A1029] border-l-4 border-accent rounded-r-lg p-6 mb-8">
                ...
                <p className="text-gray-300 mb-4">
                  <Link href="/" className="text-accent hover:underline font-semibold">3 Patti World</Link> ("we", "our", or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our mobile application and website at <a href="https://www.3pattiworldapp.com.pk" className="text-accent hover:underline" target="_blank" rel="noopener noreferrer">www.3pattiworldapp.com.pk</a> (collectively, the "Service").
              </p>
              ...
              <div className="bg-[#0A1029] rounded-xl p-6 mb-8">
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-300">
                  <li>To provide and maintain our 3 Patti World gaming Service</li>
              ...
              <div className="bg-[#0A1029] rounded-xl p-6 mb-8">
                ...
                <p className="text-gray-300 mt-4">
                  To exercise any of these rights, please contact us at <a href="mailto:support@3pattiworldapp.com.pk" className="text-accent hover:underline">support@3pattiworldapp.com.pk</a>
              </p>
              </div>
              ...
              <div className="bg-red-900/20 border-l-4 border-red-500 rounded-r-lg p-6 mb-8">
                <p className="text-gray-300 mb-4">
                  <strong className="text-white">Important:</strong> 3 Patti World is intended only for users who are 18 years of age or older. We do not knowingly collect personally identifiable information from anyone under 18 years of age.
                </p>
                <p className="text-gray-300">
              ...
              <div className="bg-accent/10 border-l-4 border-accent rounded-r-lg p-6 mb-4">
                ...
                <ul className="space-y-3 text-gray-300">
                  <li className="flex items-center">
                    ...
                    <a href="mailto:support@3pattiworldapp.com.pk" className="text-accent hover:underline">support@3pattiworldapp.com.pk</a>
                  </li>
                  <li className="flex items-center">
                    <svg className="w-5 h-5 text-accent mr-3" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <a href="https://www.3pattiworldapp.com.pk" className="text-accent hover:underline" target="_blank" rel="noopener noreferrer">www.3pattiworldapp.com.pk</a>
                  </li>
                  <li className="flex items-center">
                    <svg className="w-5 h-5 text-accent mr-3" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="bg-[#0A1029] rounded-xl p-6 mt-8 text-center">
                <p className="text-gray-400 text-sm mb-4">
                  By using 3 Patti World, you consent to this Privacy Policy and agree to its terms.
                </p>
                <p className="text-gray-400 text-sm">
                  © 2026 3 Patti World. All rights reserved.
                </p>
              </div>
            </div>
          </div>
