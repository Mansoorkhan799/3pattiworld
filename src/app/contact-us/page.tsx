...
export const metadata: Metadata = {
  title: 'Contact Us - 3 Patti World | Get Help & Support',
  description: 'Contact 3 Patti World support team for help with the app, content, privacy policy, and more. We are here to assist you.',
  keywords: 'contact 3 patti world, 3 patti world support, 3 patti world email, customer support, help 3 patti world',
  openGraph: {
    title: 'Contact Us - 3 Patti World',
    description: 'Get in touch with 3 Patti World support team for any queries or assistance.',
    url: 'https://3pattiworldapp.com.pk/contact-us',
  ...
  alternates: {
    canonical: 'https://3pattiworldapp.com.pk/contact-us',
  },
  robots: {
    index: true,
    follow: true,
        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="bg-secondary rounded-xl p-8 border-2 border-orange-200">
                ...
                <div className="text-center">
                  <a 
                    href="mailto:support@3pattiworldapp.com.pk" 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-secondary rounded-xl shadow-lg p-6 text-center hover:shadow-2xl transition-shadow duration-300">
              ...
              <p className="text-gray-400 mb-4">Need help with the 3 Patti World app?</p>
