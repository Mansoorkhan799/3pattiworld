...
export const metadata: Metadata = {
  title: 'Disclaimer - 3 Patti World | Legal Information',
  description: 'Read the disclaimer for 3 Patti World. Important legal information about the use of this blog and third-party platforms.',
  keywords: ['3 Patti World disclaimer', 'legal disclaimer', 'terms', 'conditions', 'gambling disclaimer'],
  openGraph: {
    title: 'Disclaimer - 3 Patti World',
    description: 'Legal disclaimer and important information about 3 Patti World.',
    url: 'https://3pattiworldapp.com.pk/disclaimer',
  ...
  alternates: {
    canonical: 'https://3pattiworldapp.com.pk/disclaimer',
  },
  robots: {
    index: true,
    follow: true,
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="space-y-6 text-gray-300">
                <p className="text-lg leading-relaxed">
                  The information provided on this blog (<a href="https://www.3pattiworldapp.com.pk" className="text-accent hover:text-accent font-semibold" target="_blank" rel="noopener noreferrer">www.3pattiworldapp.com.pk</a>) about <Link href="/" className="text-accent hover:underline font-semibold">3 Patti World</Link> is for <strong>general informational and entertainment purposes only</strong>. We do not host, promote, or encourage any form of gambling or betting activities.
                </p>
                ...
                <div className="bg-[#0A1029] rounded-xl p-6 border border-accent">
                  ...
                  <ul className="space-y-3 text-gray-300">
                    <li className="flex items-start">
                      ...
                      <span>3 Patti World is a card game that may involve <strong>real money</strong> when played on certain platforms.</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-accent mr-2 font-bold">•</span>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "WebPage",
            "name": "Disclaimer - 3 Patti World",
            "description": "Legal disclaimer and important information about 3 Patti World website.",
            "url": "https://3pattiworldapp.com.pk/disclaimer"
          })
        }}
      />
