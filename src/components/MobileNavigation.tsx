...
const GUIDE_LINKS: NavItem[] = [
  {
    href: '/deposit-money-in-3-patti-world',
    label: 'Deposit Guide',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
  ...
  {
    href: '/withdraw-money-from-3-patti-world',
        ...
        <div className="fixed inset-0 z-50 flex flex-col bg-[#080A21]">
          ...
          <div className="flex justify-between items-center px-5 py-4 border-b border-gray-800/80">
            <Link href="/" className="flex items-center gap-3" onClick={close}>
              ...
              <span className="text-white text-lg font-bold tracking-tight">3 Patti World</span>
            </Link>
            <button
              onClick={close}
          ...
          <div className="relative flex-1 overflow-y-auto">
            ...
            <nav className="px-5 py-2 pb-6">
              ...
              <NavSection title="INFO" items={INFO_LINKS} pathname={pathname} onNavigate={close} />
            </nav>
          </div>
